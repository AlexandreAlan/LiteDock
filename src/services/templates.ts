...
export const TEMPLATES: Template[] = [
  ...
  { slug: 'code-server', name: 'VS Code Server', description: 'VS Code oficial da Microsoft no navegador — suporte a SSH, Remote-SSH e extensões reais do marketplace.', category: 'Dev & Git', logo: ic('vscode'), website: 'https://github.com/gitpod-io/openvscode-server', variables: ['PASSWORD', 'SUDO_PASSWORD'], services: [app('lscr.io/linuxserver/openvscode-server:latest', [3000], ['/config'], { PASSWORD: '${PASSWORD}', SUDO_PASSWORD: '${SUDO_PASSWORD}', PUID: '1000', PGID: '1000', TZ: 'America/Sao_Paulo' })] },
